...
def processFile(update,bot,message,file,thread=None,jdb=None):
    ...
    if client:
        ...
        bot.editMessageText(message,'❌Error En La Pagina DPEPEE❌')
    ...
    try:
        ...
        if '/zips' in msgText:
            ...
            if getUser:
                try:
                   ...
                   jdb.save()
                   msg = '😃Genial el tamaño de los zips seran de '+ sizeof_fmt(size*1024*1024)+'📚 las partes👍'
                   bot.sendMessage(update.message.chat.id,msg)
                except:
        ...
        if '/start' in msgText:
            ...
            #    
                # set in debug
            #    api_id = 14748889
            #    api_hash = '9f1559f99aeb1a3f3ad7019e0ea93557'
            #    bot_token = '5146289648:AAFFT8qP-YFb-c8I-HkrToahoOzd2HBHSwE'
